...
class TestDataSourceVirtualboxIMC(CiTestCase):
    """
    ...
    def setUp(self):
        super(TestDataSourceVirtualboxIMC, self).setUp()
        self.datasource = DataSourceVirtualbox.DataSourceVirtualbox
    ...
    def test_get_data_false_on_none_dmi_data(self):
        ...
        result = wrap_and_call(
            "cloudinit.sources.DataSourceVirtualbox",
            {
...
class TestDataSourceVirtualboxIMC_MarkerFiles(CiTestCase):
    def setUp(self):
        super(TestDataSourceVirtualboxIMC_MarkerFiles, self).setUp()
        self.tdir = self.tmp_dir()
